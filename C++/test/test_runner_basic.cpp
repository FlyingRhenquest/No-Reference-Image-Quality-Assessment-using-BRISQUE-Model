...
int main(int argc, char *argv[])
{
  ...
  try {
    ...
    // This seems to be unreliable -- testFailuresTotal doesn't seem
    // to increase if you have test failures. I'm leaving it in anyway,
    // but if you're not using my test listener, you may get confusing
    // results from test reporting (Errors will still be reported inside
    // the test, but ctest will probably report that the test passed even
    // though it didn't.
